...
export default [
  ...
  },
  {
    ...
    tests: [
      {
        description: 'empty arrays of the error are equal',
        value1: new Error([]),
        value2: new Error([]),
        equal: true,
      },
      ...
      },
      {
        ...
        value1: new Error('some error message'),
        value2: new Error('some error message'),
        equal: true,
      },
      {
        description: 'same number of the error are equal',
        value1: new Error(1),
        value2: new Error(1),
        equal: true,
      },
      {
        description: 'same number of the error are equal (to string)',
        value1: new Error(1),
        value2: new Error('1'),
        equal: true,
      },
      {
        description: 'not equal errors',
        value1: new Error(),
        value2: new Error(1),
        equal: false,
      },
