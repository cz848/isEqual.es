...
export default [
  {
    ...
    tests: [
      {
        description: 'equal classes (constructor)',
        value1: MyClass,
        value2: MyClass,
        equal: true,
      },
      {
        description: 'equal classes',
        value1: new MyClass(),
        value2: new MyClass(),
        equal: true,
      },
      {
        description: 'not equal classes',
        value1: new MyClass(),
        value2: new SubClass(),
        equal: false,
      },
      {
        description: 'not equal classes (with constructor)',
        value1: new MyClass(),
        value2: MyClass,
        equal: false,
      },
...

  {
    ...
    tests: [
      ...
      {
        description: 'equal maps (with map key)',
        value1: map({ a: 1, [new Map()]: '2' }),
        value2: map({ a: 1, [new Map()]: '2' }),
        equal: true,
      },
      {
